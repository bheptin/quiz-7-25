...
function rovarspraket(text){
    ...
    for (var i=0; i < text.length; i++) {
      if (vowels.indexof(text[i]) > -1) {
        starterString += text[i];
      }else{
        starterString += text [i] + "o" + text [i];
      }
    }
...
function findLongestWord(sentence){
    // YOUR CODE HERE
    var strSplit = "book dogs".split("");
    var strSplit = "don't mess with Texas".split("")
